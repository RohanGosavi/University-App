...
import 'package:bottom_navigation_demo/teacher/announcelist.dart';
import 'package:flutter/material.dart';


class Hannouncement extends StatefulWidget {
  @override
  _HannouncementState createState() => _HannouncementState();
}

class _HannouncementState extends State<Hannouncement> {
            ...
            child: Column(
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  onPressed: ()async{
                    if(_formKey.currentState.validate()) {
                      _controller1.clear();
                      bool res = await obj.putData(_link, _value1, "HOD");
                      if(res) {
                ...
                ElevatedButton(
                  ...
                  onPressed: (){
                    Navigator.push(context, ScaleRoute(page: AnnouncelistPage(name: "HOD",)));
                  },
